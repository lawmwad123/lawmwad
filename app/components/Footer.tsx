        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Link href="/" className="flex items-center">
              <span className="text-2xl font-bold text-blue-400">Lawmwad</span>
              <span className="text-2xl font-bold text-white">Tech</span>
            </Link>
            <p className="text-sm leading-6 text-gray-300">
              Leading provider of AI-driven software and hardware solutions for businesses, schools, hospitals, and industries.
            </p>
